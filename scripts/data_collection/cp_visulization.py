...
def main(args):
    ...
    p.resetDebugVisualizerCamera(cameraDistance=0.17, cameraYaw=0, cameraPitch=-37, cameraTargetPosition=[0, 0, 0])
    ...
    for mesh_name in mesh_list:
        ...
        centers = info['centers'][np.logical_not(ref_col_flag)]  # [np.logical_not(ref_col_flag)]
        intersects = info['intersects'][np.logical_not(ref_col_flag)]  # [np.logical_not(ref_col_flag)]
